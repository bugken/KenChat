<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ChatClient.Register" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            <tr>
                ...
                <td>      
                    <asp:LinkButton ID="BtnLinkToLogin" runat="server" Text="已有账号?登录" OnClick="BtnLinkToLoginClick"></asp:LinkButton>
                </td>
            </tr>
        </table>
        <asp:Button ID="BtnRegister" runat="server" CssClass="transButton" Height="49px" Text="注    册" Width="500px" OnClick="BtnRegisterClick" />
    </form>
</body>
